...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::collect_lore_entries,
            commands::collect_lore_exhaustive,
            commands::make_check_fix_plan,
            commands::generate_lore_ref_image,
            ...
            commands::dialogue_stats,
            commands::list_lore_relations,
            commands::apply_lore_changes,
            commands::rollback_lore_apply,
            commands::compress_era_summaries,
            ...
            commands_video::set_video_style,
